...
class TestBug {
  ...
  static TestBug decode(Object result) {
    result as List<Object?>;
    return TestBug(
      anotherString: result[0]! as String,
    );
  }
}
...
class _UrlLauncherApiCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128: 
        return TestBug.decode(readValue(buffer)!);
      default:
...
class UrlLauncherApi {
  ...
  Future<bool> canLaunchUrl(String arg_url, TestBug? arg_testBug) async {
    const String channelName = 'dev.flutter.pigeon.url_launcher_windows.UrlLauncherApi.canLaunchUrl';
    ...
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_url, arg_testBug]) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<bool> launchUrl(String arg_url) async {
    const String channelName = 'dev.flutter.pigeon.url_launcher_windows.UrlLauncherApi.launchUrl';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
